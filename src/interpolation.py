...
def get_interpolator(method: str):
    """
    This is factory design which makes easier to implement different interpolation methods.
    You can add different interpolation methods above as in strategy design pattern.
    """
